...
public class Minigame3 extends BasicGameState{
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		...
		bloquepenguinImage=ResourceLoader.animationfromimage("res/images/Sprite-Prota-Pinguino-Enbloque.png",128,128,100);
		bloqueprotaderImage=ResourceLoader.animationfromimage("res/images/Sprite-BloqueHieloprota.png",64,64,100);
		bloqueprotaizqImage=ResourceLoader.animationfromimage("res/images/Sprite-BloqueHieloprotaizq-sheet.png",64,64,100);
