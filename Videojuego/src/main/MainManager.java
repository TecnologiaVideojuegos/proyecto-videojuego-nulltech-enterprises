...
import state_machine.minigames.minijuego4;
...
public class MainManager extends StateBasedGame {
	...
	private final int minigame4Id = 6;
	...
	public MainManager(String title) {
		...
		this.addState(new minijuego4(minigame4Id));
	}
	...
	public void initStatesList(GameContainer gc) throws SlickException {
		...
		this.getState(minigame4Id);
		this.enterState(minigame4Id); // DEBUG
	}
